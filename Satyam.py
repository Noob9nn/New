...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="*❌ You are not authorized to use this bot! PLEASE CONTACT @BADMOSH_X_GYRANGE OR try /help*", parse_mode='Markdown')
        return
...
async def chodo(update: Update, context: CallbackContext):
    ...
    # Check if the user is allowed to use the bot
    if not await is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="*❌ You are not authorized to use this bot! PLEASE CONTACT @BADMOSH_X_GYRANGE*", parse_mode='Markdown')
        return
